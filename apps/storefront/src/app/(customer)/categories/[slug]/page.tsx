...
export default function CategoryDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-950 font-sans pb-20">
      ...
      {/* Horizontal Pill Filter Bar (Strict 4 pill dropdowns as shown in screenshot) */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
          ...
          {/* Reset / Stock pill */}
          <div className="flex items-center justify-between px-4 h-11 rounded-xl border border-neutral-200 bg-neutral-50 text-xs font-bold text-neutral-700">
            <span className="flex items-center gap-1.5 text-emerald-700">
              <ShieldCheck className="w-4 h-4" /> 100% OEM Assured
            </span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        {currentProducts.length > 0 ? (
          ...
          <div className="text-center py-20 bg-neutral-50 rounded-3xl border border-dashed border-neutral-300">
            <h3 className="text-lg font-bold text-neutral-800">No hardware units found in this category</h3>
            <p className="text-xs text-neutral-500 font-mono mt-1">
              Try adjusting your price or brand filters.
            </p>
            <button
              type="button"
              onClick={() => {
