...
export const PaginationLink = ({ className, isActive, ...props }: PaginationLinkProps) => (
  <a
    ...
    className={cn(
      "inline-flex h-9 min-w-9 items-center justify-center rounded-md px-3 py-2 text-sm font-medium transition-colors hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring cursor-pointer",
      isActive
